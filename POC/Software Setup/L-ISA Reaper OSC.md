...
![loopMIDI-named](.\EGL314_TeamE\POC\Setup\Diagram\loopMIDI_named.png)

2. Add the MIDI port

![loopMIDI-add](.\EGL314_TeamE\POC\Setup\Diagram\loopMIDI_add.png)
...
![L-ISA-MIDI](.\EGL314_TeamE\POC\Setup\Diagram\L-ISA_MIDI.png)

3. Make sure your `loopMIDI Port` is setup 

![L-ISA-MIDI-1](.\EGL314_TeamE\POC\Setup\Diagram\L-ISA_MIDI_1.png)
...
![Reaper-AudioD](.\EGL314_TeamE\POC\Setup\Diagram\Reaper_AudioD.png)
...
![Reaper-Moutputs](.\EGL314_TeamE\POC\Setup\Diagram\Reaper_Moutputs.png)

8. Go to `Insert` tab, click on `SMPTE LTC/MTC Timecode Generator`

![Reaper-Timecode](.\EGL314_TeamE\POC\Setup\Diagram\Reaper_Timecode.png)

9. Double click on the `Timecode Generator` and set it to `Send MIDI (MTC)`

![Reaper-Timecode-1](.\EGL314_TeamE\POC\Setup\Diagram\Reaper_Timecode_1.png)

10. Configure the `MIDI Output` to `loopMIDI Port` for the `Timecode Generator`

![Reaper-Output](.\EGL314_TeamE\POC\Setup\Diagram\Reaper_Output.png)